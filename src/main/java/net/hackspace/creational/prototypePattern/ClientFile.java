package net.hackspace.creational.prototypePattern;
...
public class ClientFile {
	...
	public static void main(String[] args) {
		...
		while (repeatRunFlag == 1) {
			...
			if (type == 1) {
				subjectCell = specimenLab.getCellProtoType(Cell.CellProtoTypes.SINGLE_CELL_ORG);
			} else if (type == 2) {
				subjectCell = specimenLab.getCellProtoType(Cell.CellProtoTypes.AMOEBA);
			} else {
				subjectCell = specimenLab.getCellProtoType(Cell.CellProtoTypes.BACTERIA);
			}
